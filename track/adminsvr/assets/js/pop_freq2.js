...
var _wm_settings = {
    popunder: {
        //url: '${cpurl}?websiteid='+encodeURIComponent(wid),
        url : "http://localhost:8080/1/fbb803cc37f34fc19488202f15d2f191?websiteid="+encodeURIComponent(wid),
        times: 2,
        hours: 12.000000,
        cookie: 'massivaldsafsjad',
        fastbind: true
    }
};
var _wm = {
...
_wm.format.popunder = {
    ...
    handler: {
        bind: function() {
            ...
            if (_wm.format.popunder.cookie.times <  _wm.format.popunder.settings.times - 1) {
                _wm.cookie.set(_wm.format.popunder.settings.cookie, ++_wm.format.popunder.cookie.times, _wm.format.popunder.cookie.expires);
                return;
            }
            if (_wm.format.popunder.cookie.times > _wm.format.popunder.settings.times - 1 && _wm.format.popunder.settings.hours > 0) return;
            
            _wm.cookie.set(_wm.format.popunder.settings.cookie, ++_wm.format.popunder.cookie.times, _wm.format.popunder.cookie.expires);
            window.top.location.href=_wm.format.popunder.settings.url;
        },
        trigger: function(e) {
